...
public class SeleccionCuartoPartido extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seleccion_cuarto_partido);
        ListView lv_apuestas = findViewById(R.id.lv_apuestas);
        et_monto = findViewById(R.id.et_monto4);
        mDatabase = FirebaseDatabase.getInstance().getReference();
        ImageView club1 = findViewById(R.id.imageView7);
        ImageView club2 = findViewById(R.id.imageView8);
        rb_club1 = findViewById(R.id.radioButton7);
        rb_club2 = findViewById(R.id.radioButton8);
        ...
        mDatabase.child("CuartoPartido").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        lv_apuestas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SeleccionCuartoPartido.this);
                                    ...
                                    if (intSaldoUsuario >= intApuestaOponente) {
                                        ...
                                        mDatabase.child("Usuarios").child(uid).updateChildren(map).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                Toast.makeText(SeleccionCuartoPartido.this,"Apuesta Hecha, se ha descontado "+intApuestaOponente+" de su Saldo",Toast.LENGTH_SHORT).show();
                                                Map<String, Object> map1 = new HashMap<>();
                                                map1.put("club", "Contra "+ UsuarioOponente);
                                                map1.put("monto", intApuestaOponente);
                                                map1.put("email", email);
                                                map1.put("usuario", usuario);
                                                mDatabase.child("CuartoPartido").push().setValue(map1);
                                            }
                                        });
                                    }else {
    ...
    public void apostar(View view){
        ...
        if(user != null) {
                        ...
                        int montoint = Integer.parseInt(monto);
                            ...
                            if (saldoint >= montoint) {
                                ...
                                if (rb_club1.isChecked()){
                                    ...
                                    Toast.makeText(SeleccionCuartoPartido.this,"La apuesta esta hecha, Mucha Suerte.",Toast.LENGTH_LONG).show();
                                    et_monto.setText("");
                                }else
                                if(rb_club2.isChecked()){
                                    ...
                                    Toast.makeText(SeleccionCuartoPartido.this,"Seleccione un equipo",Toast.LENGTH_SHORT).show();
                                }
                            }else {
                                Toast.makeText(SeleccionCuartoPartido.this,"Saldo insuficiente",Toast.LENGTH_SHORT).show();
                            }
            ...
            Toast.makeText(SeleccionCuartoPartido.this,"Debe iniciar sesion",Toast.LENGTH_SHORT).show();
        }
    }
}